...
namespace Abp.Application.Navigation
{
    ...
    /// <see cref="MenuItemDefinition"/>菜单项定义扩展方法
    /// </summary>
    public static class MenuItemDefinitionExtensions
    {
        ...
        /// 移动一个菜单项到列表头部
        /// </summary>
        /// <param name="menuItems">List of menu items 菜单项列表</param>
        /// <param name="menuItemName">Name of the menu item to move 需要移动的菜单项名称</param>
        ...
        /// <param name="menuItems">List of menu items 菜单项列表</param>
        /// <param name="menuItemName">Name of the menu item to move 需要移动的菜单项名称</param>
        /// <param name="targetMenuItemName">Target menu item (to move before it) 目标菜单项名（移动到此菜单项之前）</param>
        ...
        /// <param name="menuItems">List of menu items 菜单项列表</param>
        /// <param name="menuItemName">Name of the menu item to move 需要移动的菜单项名称</param>
        /// <param name="targetMenuItemName">Target menu item (to move after it) 目标菜单项名（移动到此菜单项之后）</param>
